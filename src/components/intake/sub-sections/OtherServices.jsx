    ...
    <SubSection {...props} title="Other services">
      <fieldset class="space-y-4">
        ...
        <TextArea
          ...
          hint={<div>To help guide your response, you might consider:
        <ul>
          <li>Are you planning a new research, operational, or QI project?</li>
          <li>Do you need help collecting data, analyzing it, or understanding study methods?</li>
          <li>Are you looking for technical tools or platforms to support your work?</li>
          <li>Do you have a deadline, funder, or ethics requirement you're working toward?</li>
        </ul></div>}
        />
      </fieldset>
    </SubSection>
