...
export const newProjectSchema = z.object({
  'proj_type[]': z.array(z.string()).optional(),
...
export const requesterSchema = z.object({
  ...
  requester_institution_uc_faculty: z.enum(['appm', 'bmb', 'cardiac', 'cba', 'cns', 'chs', 'ccm', 'emerg', 'fam', 'gen', 'med', 'microinfect', 'obgyn', 'onc', 'ped', 'lab', 'phys', 'psych', 'rad', 'surg', '']).optional(),
  requester_institution_oth: z.enum(['uni', 'pca', 'aca', 'ra', 'ala', 'ahs', 'oth', '']).optional(),
...
export const redcapSchema = z.object({
  ...
  'rc_international_sites[]': z.array(z.string()).optional(),
...
export const customDevelopmentSchema = z.object({
  'custom_type[]': z.array(z.string()).optional(),
...
export const methodsAnalyticsSchema = z.object({
  ...
  'ma_existing_data[]': z.array(z.string()).optional(),
  ma_existing_data_pid: z.string().optional(),
  ma_data_desc: z.string().optional(),
  'ma_methods[]': z.array(z.string()).optional(),
  'ma_analytics[]': z.array(z.string()).optional(),
...
export const serviceTypeSchema = z.object({
  service_type: z.enum(['proj', 'user', 'trial', 'oth']).optional(),
});

export const researchPurposeSchema = z.object({
  'research_purpose[]': z.array(z.string()).optional(),
});
